...
const resource_uri = 'http://localhost:8080/notes'
const create_uri = 'http://localhost:8080/create'
const delete_uri = 'http://localhost:8080/delete'
const update_uri = 'http://localhost:8080/update'
const resource_uri_todos = 'http://localhost:8080/todos'
const create_uri_todos = 'http://localhost:8080/createtodo'
const delete_uri_todos = 'http://localhost:8080/deletetodo'
const update_uri_todos = 'http://localhost:8080/updatetodo'
const pin_uri_todos = 'http://localhost:8080/pintodo'
const resource_uri_shops = 'http://localhost:8080/shop'
const create_uri_shop = 'http://localhost:8080/createshop'
const update_uri_shop = 'http://localhost:8080/updateshop'
const pin_uri_shop = 'http://localhost:8080/pinshop'
const delete_uri_shop = 'http://localhost:8080/deleteshop'
