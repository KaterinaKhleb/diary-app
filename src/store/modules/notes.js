...
const resource_uri = '/notes'
const create_uri = '/create'
const delete_uri = '/delete'
const update_uri = '/update'
const resource_uri_todos = '/todos'
const create_uri_todos = '/createtodo'
const delete_uri_todos = '/deletetodo'
const update_uri_todos = '/updatetodo'
const pin_uri_todos = '/pintodo'
const resource_uri_shops = '/shop'
